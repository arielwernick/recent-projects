...
class HashTableImplTest4 {
    ...
    public void testReSize(){
        ...
        this.table.put("Key5","Value5");
        this.table.put("Key6","Value6");
        this.table.put("Key7", "Value7");
        this.table.put("Key8","Value8");
        this.table.put("Key9","Value9");
        this.table.put("Key10","Value10");
        this.table.put("Key11","Value11");
        this.table.put("Key12","Value12");
        for(int i = 1; i <= 12; i++) {
            assertEquals("Value" + i, this.table.get("Key" + i));
        }
