...
public class DocumentStoreImplTest {
    ...
    public void testDelete() {
        ...
        boolean test1a = documentStore.deleteDocument(uriArray[4]);
        boolean test1b = documentStore.deleteDocument(uriArray[4]);
        ...
        boolean test2a = documentStore.deleteDocument(uriArray[3]);
        boolean test2b = documentStore.deleteDocument(uriArray[3]);
